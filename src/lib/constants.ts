...
> = {
  SUPER: {
    ...
    permissions: [
      ...
      "Modification tarifs & créneaux",
      "Gestion annonces & utilisateurs",
      "Statistiques avancées & audit",
      "Paramètres système",
    ],
  },
  VALIDATION: {
    ...
    permissions: [
      "Tableau & calendrier des RDV",
      "Création / modification / annulation",
      "Revue & approbation des contrôles",
  ...
  RECEPTION: {
    ...
    permissions: [
      "Vérification par QR (caméra)",
      "Vérification par code manuel (6 car.)",
