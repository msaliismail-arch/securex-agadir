...
export const metadata: Metadata = {
  metadataBase: new URL(
    "https://securex-agadir-fta3.vercel.app",
  ),

  title: {
    default:
      "SÉCUREX CONNECT — Contrôle Technique Automobile Agréé à Agadir",
  ...
  openGraph: {
    ...
    url: "https://securex-agadir-fta3.vercel.app",
  ...
  twitter: {
    ...
    title:
      "SÉCUREX CONNECT — Contrôle Technique Agréé à Agadir",

    description:
      "Réservation en ligne, contrôle fiable, certificat officiel.",
  },
};
